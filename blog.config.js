...
const BLOG = {
  ...
  PREVIEW_CATEGORY_COUNT: 2, // 首页最多展示的分类数量，0为不限制
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '12597400772', // 对应歌单的 id
